...
def main_menu_keyboard(lang = "en"):
    ...
    if lang == "en":
       ...
       keyboard = [[InlineKeyboardButton('जोड़ें ➕', callback_data='menu_add'), InlineKeyboardButton('संपादित करें 📝', callback_data='menu_edit')],
[InlineKeyboardButton('कौन है 👤', callback_data='menu_who'), InlineKeyboardButton('प्रोफ़ाइल 😎', callback_data='menu_profile')],
[InlineKeyboardButton('सेटिंग्स ⚙', callback_data='menu_settings'), InlineKeyboardButton('सब्सक्रिप्शन 🎫', callback_data='menu_sub')]]

    elif lang == "ch":
        keyboard =[[InlineKeyboardButton('添加 ➕', callback_data='menu_add'), InlineKeyboardButton('编辑 📝', callback_data='menu_edit')],
[InlineKeyboardButton('谁是 👤', callback_data='menu_who'), InlineKeyboardButton('档案 😎', callback_data='menu_profile')],
[InlineKeyboardButton('设置 ⚙', callback_data='menu_settings'), InlineKeyboardButton('订阅 🎫', callback_data='menu_sub')]]
