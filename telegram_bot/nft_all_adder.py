...
class ChatIdAsKeyNFT:
    ...
    def _read_from_attribute_json(other_file=False):
        ...
        read_file = "nft_chat_id_val.json"
    ...
    def _write_into_attribute_json(data: dict, other_file=False):
        ...
        write_file = "nft_chat_id_val.json"
    ...
    def get_wallets(self, chat_id: str):
        dataa = self._read_from_attribute_json()
        try:
            return dataa[chat_id]
        except:
            return ["don't track anything now"]
    ...
    def add_NFT(self, coin: str, chat_id: str):
        ...
        if self._check_input(coin):
            ...
            return "please input a relevant NFT", False
